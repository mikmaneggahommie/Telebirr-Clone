...
.method private setTranslation(FZZ)V
    ...
    iget-object v12, p0, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;->mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    .line 379
    .local v12, "otherView":Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    :goto_3
    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;->getMinTranslationAmount()I
    ...
    :goto_4
    invoke-direct {p0, v9}, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;->getRadiusFromTranslation(F)F
    ...
    invoke-virtual {v12}, Lcom/android/systemui/statusbar/KeyguardAffordanceView;->getRestingAlpha()F
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;->updateIcon(Lcom/android/systemui/statusbar/KeyguardAffordanceView;FFZZ)V
    ...
    .end local v11    # "fadeOutAlpha":F
    .end local v12    # "otherView":Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    :cond_1
    return-void

    .line 373
    .end local v9    # "absTranslation":F
    :cond_2
    const/4 v0, 0x0
    ...
    .line 377
    .restart local v9    # "absTranslation":F
    :cond_4
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;->mRightIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    ...
    :cond_5
    iget-object v12, p0, Lcom/android/systemui/statusbar/phone/KeyguardAffordanceHelper;->mLeftIcon:Lcom/android/systemui/statusbar/KeyguardAffordanceView;

    goto :goto_3

    .line 385
    .restart local v10    # "alpha":F
    .restart local v11    # "fadeOutAlpha":F
    .restart local v12    # "otherView":Lcom/android/systemui/statusbar/KeyguardAffordanceView;
    :cond_6
    const/4 v7, 0x0
    ...
    .restart local v7    # "animateIcons":Z
    :cond_7
    const/4 v8, 0x0
    ...
    .line 392
    .restart local v8    # "slowAnimation":Z
    :cond_8
    const/4 v5, 0x0
