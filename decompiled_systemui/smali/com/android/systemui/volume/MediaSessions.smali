...
.field private static final USE_SERVICE_LABEL:Z
...
.method public static dumpMediaSessions(Landroid/content/Context;)V
    .locals 10
    ...
    .line 247
    .local v4, "mgr":Landroid/media/session/MediaSessionManager;
    const/4 v7, 0x0

    :try_start_0
    invoke-virtual {v4, v7}, Landroid/media/session/MediaSessionManager;->getActiveSessions(Landroid/content/ComponentName;)Ljava/util/List;

    move-result-object v1

    .line 248
    .local v1, "controllers":Ljava/util/List;, "Ljava/util/List<Landroid/media/session/MediaController;>;"
    ...
    sget-object v7, Lcom/android/systemui/volume/MediaSessions;->TAG:Ljava/lang/String;
    ...
    invoke-static {v8, v5, v7}, Lcom/android/systemui/volume/MediaSessions;->dump(ILjava/io/PrintWriter;Landroid/media/session/MediaController;)V
    ...
    .line 256
    .end local v0    # "N":I
    .end local v1    # "controllers":Ljava/util/List;, "Ljava/util/List<Landroid/media/session/MediaController;>;"
    .end local v3    # "i":I
    ...
    const-string v8, "Not allowed to get sessions"
