...
.method private onGetStateW()V
    ...
    invoke-virtual {v8, v7}, Landroid/media/AudioManager;->isStreamMute(I)Z
    ...
    .line 419
    sget-object v8, Lcom/android/systemui/volume/VolumeDialogController;->TAG:Ljava/lang/String;

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "onGetStateW : "
    ...
    invoke-virtual {v8, v7}, Landroid/media/AudioManager;->getLastAudibleStreamVolume(I)I

    move-result v2

    .line 428
    .local v2, "lastAudibleStreamVolume":I
    invoke-direct {p0, v7, v2}, Lcom/android/systemui/volume/VolumeDialogController;->updateStreamLevelW(II)Z
    ...
    iget-object v9, p0, Lcom/android/systemui/volume/VolumeDialogController;->mAudio:Landroid/media/AudioManager;

    invoke-virtual {v9, v7}, Landroid/media/AudioManager;->getStreamMinVolume(I)I

    move-result v9

    iput v9, v8, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->levelMin:I
    ...
    invoke-virtual {v9, v7}, Landroid/media/AudioManager;->getStreamMaxVolume(I)I

    move-result v9

    iput v9, v8, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->levelMax:I
    ...
    .line 433
    .local v6, "ss":Lcom/android/systemui/volume/VolumeDialogController$StreamState;
    iget-object v8, p0, Lcom/android/systemui/volume/VolumeDialogController;->mAudio:Landroid/media/AudioManager;

    invoke-virtual {v8, v7}, Landroid/media/AudioManager;->isStreamAffectedByMute(I)Z

    move-result v8

    iput-boolean v8, v6, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->muteSupported:Z

    .line 434
    sget-object v8, Lcom/android/systemui/volume/VolumeDialogController;->STREAMTITLES:[I
    ...
    iput-object v8, v6, Lcom/android/systemui/volume/VolumeDialogController$StreamState;->name:Ljava/lang/String;
    ...
    .end local v6    # "ss":Lcom/android/systemui/volume/VolumeDialogController$StreamState;
...
.method private onVolumeChangedW(II)V
    ...
    invoke-virtual {v10, v0}, Landroid/media/AudioManager;->getLastAudibleStreamVolume(I)I

    move-result v4

    .line 345
    .local v4, "lastAudibleStreamVolume":I
    move/from16 v0, p1

    invoke-direct {p0, v0, v4}, Lcom/android/systemui/volume/VolumeDialogController;->updateStreamLevelW(II)Z
    ...
    :goto_6
    invoke-direct {p0, v10}, Lcom/android/systemui/volume/VolumeDialogController;->checkRoutedToBluetoothW(I)Z
    ...
    const-string v12, "onVolumeChangedW stream = "
    ...
    const-string v12, ", lastAudibleStreamVolume = "
    ...
    invoke-virtual {v10}, Landroid/sec/enterprise/EnterpriseDeviceManager;->getKnoxCustomManager()Lcom/sec/enterprise/knoxcustom/KnoxCustomManager;
    ...
    invoke-virtual {v3}, Lcom/sec/enterprise/knoxcustom/KnoxCustomManager;->getVolumePanelEnabledState()Z
    ...
    .line 355
    sget-boolean v10, Lcom/android/systemui/volume/D;->BUG:Z

    if-eqz v10, :cond_3

    sget-object v10, Lcom/android/systemui/volume/VolumeDialogController;->TAG:Ljava/lang/String;

    const-string v11, "Knox Customization: Not showing volume dialog"

    invoke-static {v10, v11}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 363
    .end local v3    # "knoxCustomManager":Lcom/sec/enterprise/knoxcustom/KnoxCustomManager;
    :cond_3
    :goto_7
    if-eqz v5, :cond_4
    ...
    invoke-virtual {v10}, Lcom/android/systemui/volume/VolumeDialogController$C;->onPlaySound()V
    ...
    invoke-virtual {v10}, Lcom/android/systemui/volume/VolumeDialogController$C;->onStopSound()V
    ...
    invoke-virtual {v10}, Lcom/android/systemui/volume/VolumeDialogController$C;->onShowVibrateHint()V
    ...
    invoke-virtual {v10}, Lcom/android/systemui/volume/VolumeDialogController$C;->onShowSilentHint()V
    ...
    invoke-static {v10, v11, v12}, Lcom/android/systemui/volume/Events;->writeEvent(Landroid/content/Context;I[Ljava/lang/Object;)V

    .line 378
    const/4 v10, 0x1

    iput-boolean v10, p0, Lcom/android/systemui/volume/VolumeDialogController;->mFromKey:Z
    ...
    .end local v2    # "fromKey":Z
    .end local v4    # "lastAudibleStreamVolume":I
    .end local v5    # "playSound":Z
    .end local v6    # "removeSound":Z
    .end local v7    # "showSilentHint":Z
    .end local v8    # "showUI":Z
    .end local v9    # "showVibrateHint":Z
    :cond_9
    const/4 v8, 0x0
    ...
    .line 328
    .restart local v9    # "showVibrateHint":Z
    :cond_c
    const/4 v7, 0x0
    ...
    .line 329
    .restart local v7    # "showSilentHint":Z
    :cond_d
    const/4 v5, 0x0
    ...
    .restart local v4    # "lastAudibleStreamVolume":I
    .restart local v6    # "removeSound":Z
    :cond_f
    move/from16 v10, p1
    ...
    .line 358
    .restart local v3    # "knoxCustomManager":Lcom/sec/enterprise/knoxcustom/KnoxCustomManager;
    :cond_10
    iget-object v10, p0, Lcom/android/systemui/volume/VolumeDialogController;->mCallbacks:Lcom/android/systemui/volume/VolumeDialogController$C;

    const/4 v11, 0x1

    invoke-virtual {v10, v11}, Lcom/android/systemui/volume/VolumeDialogController$C;->onShowRequested(I)V
...
.method public destroy()V
    ...
    iput-boolean v0, p0, Lcom/android/systemui/volume/VolumeDialogController;->mDestroyed:Z
    ...
    invoke-virtual {v0}, Lcom/android/systemui/volume/MediaSessions;->destroy()V

    .line 198
    iget-object v0, p0, Lcom/android/systemui/volume/VolumeDialogController;->mObserver:Lcom/android/systemui/volume/VolumeDialogController$SettingObserver;

    invoke-virtual {v0}, Lcom/android/systemui/volume/VolumeDialogController$SettingObserver;->destroy()V

    .line 199
    iget-object v0, p0, Lcom/android/systemui/volume/VolumeDialogController;->mReceiver:Lcom/android/systemui/volume/VolumeDialogController$Receiver;

    invoke-virtual {v0}, Lcom/android/systemui/volume/VolumeDialogController$Receiver;->destroy()V
...
.method public removeCallback(Lcom/android/systemui/volume/VolumeDialogController$Callbacks;)V
    .locals 1
    .param p1, "callback"    # Lcom/android/systemui/volume/VolumeDialogController$Callbacks;
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/volume/VolumeDialogController$C;->remove(Lcom/android/systemui/volume/VolumeDialogController$Callbacks;)V
...
.method public setExitCondition(Landroid/service/notification/Condition;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/systemui/volume/VolumeDialogController$W;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
