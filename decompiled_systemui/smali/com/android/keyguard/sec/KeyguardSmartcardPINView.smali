...
.method static synthetic access$600(Lcom/android/keyguard/sec/KeyguardSmartcardPINView;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/keyguard/sec/KeyguardSmartcardPINView;
...
.method static synthetic access$700(Lcom/android/keyguard/sec/KeyguardSmartcardPINView;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/keyguard/sec/KeyguardSmartcardPINView;
    .param p1, "x1"    # Z
...
.method static synthetic access$800(Lcom/android/keyguard/sec/KeyguardSmartcardPINView;ZI)V
    .locals 0
    .param p0, "x0"    # Lcom/android/keyguard/sec/KeyguardSmartcardPINView;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
    ...
    .prologue
    .line 75
    invoke-direct {p0, p1, p2}, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->verifyPasswordAndUnlock(ZI)V

    return-void
.end method

.method static synthetic access$902(Lcom/android/keyguard/sec/KeyguardSmartcardPINView;Landroid/os/AsyncTask;)Landroid/os/AsyncTask;
    .locals 0
    .param p0, "x0"    # Lcom/android/keyguard/sec/KeyguardSmartcardPINView;
    ...
    .prologue
    .line 75
    iput-object p1, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mPendingLockCheck:Landroid/os/AsyncTask;

    return-object p1
.end method

.method private verifyPasswordAndUnlock(ZI)V
    .locals 6
    .param p1, "status"    # Z
    ...
    .line 312
    .local v1, "errMsg":I
    sput-boolean v5, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mSmartcardAuthProgress:Z

    .line 313
    sget-object v2, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->TAG:Ljava/lang/String;
    ...
    .line 316
    iget-object v2, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mPendingLockCheck:Landroid/os/AsyncTask;
    ...
    const-string v3, "verifyPasswordAndUnlock: with mPendingLockCheck"

    invoke-static {v2, v3}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 322
    iget-object v2, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-static {}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getCurrentUser()I

    move-result v3

    new-instance v4, Lcom/android/keyguard/sec/KeyguardSmartcardPINView$2;

    invoke-direct {v4, p0, v0, v1}, Lcom/android/keyguard/sec/KeyguardSmartcardPINView$2;-><init>(Lcom/android/keyguard/sec/KeyguardSmartcardPINView;Ljava/lang/String;I)V
    ...
    iput-object v2, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mPendingLockCheck:Landroid/os/AsyncTask;
    ...
    .line 333
    :cond_1
    invoke-virtual {p0, v0, v5, v1}, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->onPasswordChecked(Ljava/lang/String;ZI)V
...
.method protected onPasswordChecked(Ljava/lang/String;ZI)V
    ...
    .line 342
    iget-object v1, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mCallback:Lcom/android/keyguard/KeyguardSecurityCallback;
    ...
    .line 358
    :goto_0
    invoke-virtual {p0, v6}, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->resetPasswordText(Z)V
    ...
    iput-object v1, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mEntry:Ljava/lang/String;
    ...
    .line 362
    invoke-virtual {p0, v7}, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->setKeepScreenOn(Z)V
    ...
    .line 348
    iget-object v1, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mContext:Landroid/content/Context;
    ...
    :cond_2
    iget-object v1, p0, Lcom/android/keyguard/sec/KeyguardSmartcardPINView;->mSecurityMessageDisplay:Lcom/android/keyguard/SecurityMessageDisplay;
