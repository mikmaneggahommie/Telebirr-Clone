  ...
  const ScreenContent = (
    ...
    >
      ...
      <div className="flex-1 w-full h-full flex flex-col relative overflow-hidden pointer-events-none">
        ...
        {/* Amount */}
        <div className="w-full flex items-baseline justify-center gap-1 mt-[74px] translate-x-[1px] mb-8">
          ...
          <span className="text-[11px] font-[410] text-[#222] leading-none mb-0.5">
            (ETB)
          </span>
        </div>
