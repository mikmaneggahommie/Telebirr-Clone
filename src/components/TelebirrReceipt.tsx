    ...
    >
      ...
      <div className="flex-1 w-full h-full flex flex-col relative overflow-hidden pointer-events-none">
        ...
        <div className="w-full flex flex-col items-center justify-center mt-[9px] translate-x-[2px]">
          <span className="text-[#8dc73f] text-[13.5px] font-[400] tracking-[0.2px] leading-none">Successful</span>
        </div>

        {/* Amount */}
        <div className="w-full flex items-baseline justify-center gap-1 mt-[80px] -translate-x-[2px] mb-8">
