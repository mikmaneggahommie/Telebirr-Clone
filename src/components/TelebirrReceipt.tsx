  ...
  const ScreenContent = (
    ...
    >
      ...
      <div className="flex-1 w-full h-full flex flex-col relative overflow-hidden pointer-events-none">
        ...
        {/* Amount */}
        <div className="w-full flex items-baseline justify-center gap-1 mt-[80px] -translate-x-[5px] mb-8">
          <span className="text-[31.5px] font-[400] text-[#222] tracking-tighter leading-none">
            -{data.amount.toString().replace(/[^0-9.]/g, "").split(".")[0] || "0"}.00
          </span>
          <span className="text-[11px] font-[400] text-[#222] leading-none mb-0.5">
            (ETB)
          </span>
        </div>
